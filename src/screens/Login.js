      ...
      return (
        <View>
          ...
          <View style={{ margin: 20, borderRadius: 20 }}>
            <Text style={{ color: '#000', fontSize: 20, textAlign:'center'}}>Selamat datang !</Text>
            <Text style={{ color: '#000', fontSize: 16, textAlign:'center', marginBottom: 20 }}>Silakan Login!</Text>
